...
"#,
    ...
    // - community/helper (transitive from agent) uses claude-code → .claude/snippets/agpm/snippets/helper.md
    ...
    let community_helper = project.project_path().join(".claude/snippets/agpm/snippets/helper.md");
